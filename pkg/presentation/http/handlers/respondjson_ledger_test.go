...
// nunca o suba.
//
// 108 na fundação da migração DTO (2026-08-27, /group/info); 96 depois da
// família de utilizadores, contactos e blocklist — doze sítios de chamada
// passaram a servir DTO.
const maxPendingRespondJSONSites = 96
