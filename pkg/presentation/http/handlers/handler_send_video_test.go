...
func TestSendVideo_Caption_ForwardedFromRequest(t *testing.T) {
	mm := &contractsfake.MediaMessenger{
		SendVideoFunc: func(_ context.Context, _ string, _ domain.JID, payload domain.MediaPayload, _ *domain.ReplyContext, _ []string, _ string) (domain.MessageSendResult, error) {
