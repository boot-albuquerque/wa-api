...
func NewDefaultMatrix() *matrix {
	...
	rows := []row{
		...
		{domain.CapSendText, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: pkg/infra/wa-noise/adapters/chat/messenger.go. wa_headless: " + absentAdapter},
		{domain.CapSendLocation, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/chat/messenger.go. wa_headless: " + absentAdapter},
		{domain.CapSendContact, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/chat/messenger.go. wa_headless: " + absentAdapter},
		{domain.CapSendPoll, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/chat/messenger.go. wa_headless: " + absentAdapter},
		{domain.CapSendTemplate, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/chat/messenger.go. wa_headless: " + absentAdapter},
		{domain.CapSendList, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/chat/messenger.go. wa_headless: " + absentAdapter},
		{domain.CapSendImage, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/chat/messenger.go. wa_headless: " + absentAdapter},
		{domain.CapSendDocument, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/chat/messenger.go. wa_headless: " + absentAdapter},
		{domain.CapSendAudio, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/chat/messenger.go. wa_headless: " + absentAdapter},
		{domain.CapSendVideo, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/chat/messenger.go. wa_headless: " + absentAdapter},
		{domain.CapSendSticker, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/chat/messenger.go. wa_headless: " + absentAdapter},
		{domain.CapSendButtons, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/chat/messenger.go. wa_headless: " + absentAdapter},
		{domain.CapSendCarousel, domain.StatusSupported, domain.EvidenceConfirmed, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: field-verified, HOUSEKEEP.md F216 (photographed on device). wa_headless: " + absentAdapter},
		{domain.CapForwardMessage, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/chat/forward.go. wa_headless: " + absentAdapter},
		...
		{domain.CapStarMessage, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go, via app-state patch (appstate.BuildStar) — NOTE this contradicts docs/CAPACIDADES.md's stale claim that StarMessage 'não existe'; that document is self-flagged desatualizado since 2026-08-24. wa_headless: " + absentAdapter},
		...
		{domain.CapSubscribePresence, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/presence/controller.go. wa_headless: " + absentAdapter},
		...
		{domain.CapMuteChat, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go, via app-state patch (appstate.BuildMute) — contradicts stale docs/CAPACIDADES.md claim, see CapStarMessage note. wa_headless: " + absentAdapter},
		{domain.CapPinChat, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go, via app-state patch (appstate.BuildPin). wa_headless: " + absentAdapter},
		{domain.CapRejectCall, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapRequestUnavailableMessage, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapSetDisappearingTimerChat, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapSetDefaultDisappearingTimer, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapSetStatusMessage, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapRequestHistorySync, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		...
		// --- Media -----------------------------------------------------
		{domain.CapDownloadMedia, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/chat/downloader.go. wa_headless: " + absentAdapter},
		...
		{domain.CapGetNewsletterInfo, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapGetNewsletterInfoByInvite, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter + " (grep matched only NewsletterInfo, not the ByInvite variant, in wa_noise too — recorded together with NewsletterInfo since both live in the same adapter method family; treat as same confidence)"},
		{domain.CapFollowNewsletter, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapUnfollowNewsletter, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapMuteNewsletter, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapListNewsletterMessages, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapListNewsletterMessageUpdates, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapMarkNewsletterViewed, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapReactToNewsletterMessage, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapSubscribeNewsletterLiveUpdates, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapDemoteNewsletterAdmin, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapChangeNewsletterOwner, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapDeleteNewsletter, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapInviteNewsletterAdmin, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go (CreateNewsletterAdminInvite). wa_headless: " + absentAdapter},
		{domain.CapAcceptNewsletterAdminInvite, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapRevokeNewsletterAdminInvite, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/misc/adapter.go. wa_headless: " + absentAdapter},
		...
		{domain.CapSetGroupEphemeralTimer, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/group/adapter.go. wa_headless: " + absentAdapter + " — port doc comment (GroupEphemeralSetter) says explicitly this one has NOT been measured on headless, unlike GroupPhotoSetter"},
		{domain.CapGetSubGroups, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/group/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapGetLinkedGroupsParticipants, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/group/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapLinkGroupToCommunity, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/group/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapUnlinkGroupFromCommunity, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/group/adapter.go. wa_headless: " + absentAdapter},
		...
		{domain.CapGetPrivacySettings, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/user/adapter.go. wa_headless: " + absentAdapter},
		{domain.CapSetPrivacySetting, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/user/adapter.go. wa_headless: " + absentAdapter},

		// --- Pairing / session lifecycle ----------------------------------
		{domain.CapCheckPairingStatus, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/pairing/adapter.go. wa_headless: " + absentAdapter + " — plausible this is engine_unsupported (headless auth is QR/cookie-based, not a pairing code), but that has not been confirmed by reading the auth flow, so it stays unknown rather than asserted"},
		{domain.CapRequestPairingCode, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/pairing/adapter.go. wa_headless: " + absentAdapter + " (same caveat as check_pairing_status)"},
		...
		{domain.CapLogoutSession, domain.StatusSupported, domain.EvidenceProbable, domain.StatusUnknown, domain.EvidenceProbable, "wa_noise: adapters/user/adapter.go (or session teardown path). wa_headless: " + absentAdapter},
	}
