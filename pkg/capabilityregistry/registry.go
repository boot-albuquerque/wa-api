...
func (r *CapabilityRegistry) Decide(capability domain.Capability, engine domain.Engine, accountType domain.AccountType, failedPreconditions ...string) (CapabilityDecision, error) {
