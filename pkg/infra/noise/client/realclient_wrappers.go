...
// PROMOVIA os métodos de `*noise.Client` em vez de os escrever — promoção não
...
func (r RealClient) SendMessage(ctx context.Context, to types.JID, message *waE2E.Message, extra ...noise.SendRequestExtra) (noise.SendResponse, error) {
	v0, err := r.Client.SendMessage(ctx, to, message, extra...)
	return v0, errmap.ClassifyIQ(err)
}

func (r RealClient) Upload(ctx context.Context, plaintext []byte, appInfo noise.MediaType) (noise.UploadResponse, error) {
	v0, err := r.Client.Upload(ctx, plaintext, appInfo)
	return v0, errmap.ClassifyIQ(err)
}

func (r RealClient) Download(ctx context.Context, msg noise.DownloadableMessage) ([]byte, error) {
...
func (r RealClient) CreateGroup(ctx context.Context, req noise.ReqCreateGroup) (*types.GroupInfo, error) {
...
func (r RealClient) UpdateGroupParticipants(ctx context.Context, jid types.JID, participantChanges []types.JID, action noise.ParticipantChange) ([]types.GroupParticipant, error) {
...
func (r RealClient) UpdateGroupRequestParticipants(ctx context.Context, jid types.JID, participantChanges []types.JID, action noise.ParticipantRequestChange) ([]types.GroupParticipant, error) {
...
func (r RealClient) GetProfilePictureInfo(ctx context.Context, jid types.JID, params *noise.GetProfilePictureParams) (*types.ProfilePictureInfo, error) {
...
func (r RealClient) SendPeerMessage(ctx context.Context, message *waE2E.Message) (noise.SendResponse, error) {
...
func (r RealClient) CreateNewsletter(ctx context.Context, params noise.CreateNewsletterParams) (*types.NewsletterMetadata, error) {
...
func (r RealClient) UnfollowNewsletter(ctx context.Context, jid types.JID) error {
	return errmap.ClassifyNewsletter(errmap.ClassifyIQ(r.Client.UnfollowNewsletter(ctx, jid)), errmap.OpNewsletterUnfollow)
}
...
func (r RealClient) GetNewsletterMessages(ctx context.Context, jid types.JID, params *noise.GetNewsletterMessagesParams) ([]*types.NewsletterMessage, error) {
	v0, err := r.Client.GetNewsletterMessages(ctx, jid, params)
	return v0, errmap.ClassifyNewsletter(errmap.ClassifyIQ(err), "")
}

func (r RealClient) GetNewsletterMessageUpdates(ctx context.Context, jid types.JID, params *noise.GetNewsletterUpdatesParams) ([]*types.NewsletterMessage, error) {
...
func (r RealClient) NewsletterDemoteAdmin(ctx context.Context, channelJID, userJID types.JID) error {
	return errmap.ClassifyNewsletter(errmap.ClassifyIQ(r.Client.NewsletterDemoteAdmin(ctx, channelJID, userJID)), errmap.OpNewsletterDemote)
}
...
func (r RealClient) NewsletterCreateAdminInvite(ctx context.Context, channelJID, userJID types.JID) (noise.NewsletterAdminInvite, error) {
