...
func (f *Fake) CreateNewsletter(ctx context.Context, params noise.CreateNewsletterParams) (*types.NewsletterMetadata, error) {
...
func (f *Fake) GetNewsletterMessages(ctx context.Context, jid types.JID, params *noise.GetNewsletterMessagesParams) ([]*types.NewsletterMessage, error) {
...
func (f *Fake) GetNewsletterMessageUpdates(ctx context.Context, jid types.JID, params *noise.GetNewsletterUpdatesParams) ([]*types.NewsletterMessage, error) {
...
func (f *Fake) NewsletterCreateAdminInvite(ctx context.Context, channelJID, userJID types.JID) (noise.NewsletterAdminInvite, error) {
	if f.NewsletterCreateAdminInviteFn != nil {
		return f.NewsletterCreateAdminInviteFn(ctx, channelJID, userJID)
	}
	return noise.NewsletterAdminInvite{}, nil
}
