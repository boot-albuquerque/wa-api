...
func (f *Fake) CreateGroup(ctx context.Context, req noise.ReqCreateGroup) (*types.GroupInfo, error) {
...
func (f *Fake) UpdateGroupParticipants(ctx context.Context, jid types.JID, participantChanges []types.JID, action noise.ParticipantChange) ([]types.GroupParticipant, error) {
...
func (f *Fake) UpdateGroupRequestParticipants(ctx context.Context, jid types.JID, participantChanges []types.JID, action noise.ParticipantRequestChange) ([]types.GroupParticipant, error) {
