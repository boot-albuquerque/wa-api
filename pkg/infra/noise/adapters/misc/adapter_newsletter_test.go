...
func comCliente(f *testkit.Fake) *MiscAdapter {
	return NewMiscAdapter(testkit.GetterWith(map[string]client.Client{"u1": f}))
}
...
func TestNewsletterAdapter_CreatePassaOsCamposDeCriacao(t *testing.T) {
	var p noise.CreateNewsletterParams
	fake := &testkit.Fake{
		CreateNewsletterFn: func(_ context.Context, params noise.CreateNewsletterParams) (*types.NewsletterMetadata, error) {
			p = params
			return nil, nil
		},
	}
...
func TestNewsletterAdapter_ServerIDDeTextoInvalidoVaiZero(t *testing.T) {
	var got *noise.GetNewsletterMessagesParams
	fake := &testkit.Fake{
		GetNewsletterMessagesFn: func(_ context.Context, _ types.JID, params *noise.GetNewsletterMessagesParams) ([]*types.NewsletterMessage, error) {
			got = params
			return nil, nil
		},
	}
...
func TestNewsletterAdapter_CaminhoDeSucessoDasOnze(t *testing.T) {
	...
	fake := &testkit.Fake{
		CreateNewsletterFn: func(context.Context, noise.CreateNewsletterParams) (*types.NewsletterMetadata, error) {
			chamado = "create"
			return nil, nil
		},
		...
		GetNewsletterMessagesFn: func(context.Context, types.JID, *noise.GetNewsletterMessagesParams) ([]*types.NewsletterMessage, error) {
			chamado = "messages"
			return nil, nil
		},
		GetNewsletterMessageUpdatesFn: func(context.Context, types.JID, *noise.GetNewsletterUpdatesParams) ([]*types.NewsletterMessage, error) {
			chamado = "updates"
			return nil, nil
		},
...
func TestNewsletterAdapter_DeadlineAppliedToAllEleven(t *testing.T) {
	...
	fake := &testkit.Fake{
		CreateNewsletterFn: func(ctx context.Context, _ noise.CreateNewsletterParams) (*types.NewsletterMetadata, error) {
		...
		GetNewsletterMessagesFn: func(ctx context.Context, _ types.JID, _ *noise.GetNewsletterMessagesParams) ([]*types.NewsletterMessage, error) {
			checkDeadline(ctx, "messages")
			return nil, nil
		},
		GetNewsletterMessageUpdatesFn: func(ctx context.Context, _ types.JID, _ *noise.GetNewsletterUpdatesParams) ([]*types.NewsletterMessage, error) {
