...
func resolveBlocklistPNJID(ctx context.Context, client clientpkg.Client, jid types.JID) (types.JID, error) {
...
func resolveBlocklistPN(ctx context.Context, client clientpkg.Client, jid types.JID) types.JID {
	switch jid.Server {
	case types.DefaultUserServer:
		return jid
	case types.HiddenUserServer:
...
func getCachedLIDForPN(ctx context.Context, client clientpkg.Client, jid types.JID) (types.JID, error) {
	store := client.Store()
...
func getCachedPNForLID(ctx context.Context, client clientpkg.Client, jid types.JID) (types.JID, error) {
	store := client.Store()
	if store == nil || store.LIDs == nil {
