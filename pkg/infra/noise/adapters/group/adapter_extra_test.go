...
func TestGroupAdapter_PropagatesErrors(t *testing.T) {
	...
	cases := []struct {
		...
		{"CreateGroup", fakeSpec{
			setup: func() *testkit.Fake {
				return &testkit.Fake{CreateGroupFn: func(ctx context.Context, req noise.ReqCreateGroup) (*types.GroupInfo, error) {
					return nil, sdkErr
				}}
			},
			call: func(a *GroupAdapter) error {
		...
		{"UpdateGroupParticipants", fakeSpec{
			setup: func() *testkit.Fake {
				return &testkit.Fake{UpdateGroupParticipantsFn: func(ctx context.Context, jid types.JID, p []types.JID, action noise.ParticipantChange) ([]types.GroupParticipant, error) {
					return nil, sdkErr
				}}
			},
			call: func(a *GroupAdapter) error {
		...
		{"UpdateRequestParticipants", fakeSpec{
			setup: func() *testkit.Fake {
				return &testkit.Fake{UpdateGroupRequestParticipantsFn: func(ctx context.Context, jid types.JID, p []types.JID, action noise.ParticipantRequestChange) ([]types.GroupParticipant, error) {
					return nil, sdkErr
				}}
			},
			call: func(a *GroupAdapter) error {
