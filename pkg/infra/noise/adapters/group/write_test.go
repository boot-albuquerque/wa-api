...
func TestGroupAdapter_CreateGroup_OK(t *testing.T) {
	called := false
	fake := &testkit.Fake{CreateGroupFn: func(ctx context.Context, req noise.ReqCreateGroup) (*types.GroupInfo, error) {
		called = true
		if req.Name != "MyGroup" {
	...
	a := NewGroupAdapter(testkit.GetterWith(map[string]client.Client{"u1": fake}))
...
func TestGroupAdapter_JoinGroup_OK(t *testing.T) {
	called := false
	fake := &testkit.Fake{JoinGroupWithLinkFn: func(ctx context.Context, code string) (types.JID, error) {
		called = true
...
func TestGroupAdapter_JoinGroup_NoSession(t *testing.T) {
	...
	if testkit.AppErrCode(err) != "no_session" {
		t.Errorf("JoinGroup code = %q", testkit.AppErrCode(err))
	}
}
...
func TestGroupAdapter_LeaveGroup_NoSession(t *testing.T) {
	...
	if testkit.AppErrCode(err) != "no_session" {
		t.Errorf("LeaveGroup code = %q", testkit.AppErrCode(err))
	}
}
...
func TestGroupAdapter_LeaveGroup_OK(t *testing.T) {
	called := false
	fake := &testkit.Fake{LeaveGroupFn: func(ctx context.Context, jid types.JID) error {
		called = true
		return nil
	}}
	a := NewGroupAdapter(testkit.GetterWith(map[string]client.Client{"u1": fake}))
...
func TestGroupAdapter_SetGroupName_OK(t *testing.T) {
	called := false
	fake := &testkit.Fake{SetGroupNameFn: func(ctx context.Context, jid types.JID, name string) error {
		called = true
		if name != "NewName" {
...
func TestGroupAdapter_SetGroupName_NoSession(t *testing.T) {
	...
	if testkit.AppErrCode(err) != "no_session" {
		t.Errorf("SetGroupName code = %q", testkit.AppErrCode(err))
	}
}
...
func TestGroupAdapter_SetGroupTopic_OK(t *testing.T) {
	called := false
	fake := &testkit.Fake{SetGroupTopicFn: func(ctx context.Context, jid types.JID, prev, new, topic string) error {
		called = true
...
func TestGroupAdapter_SetGroupTopic_NoSession(t *testing.T) {
	...
	if testkit.AppErrCode(err) != "no_session" {
		t.Errorf("SetGroupTopic code = %q", testkit.AppErrCode(err))
	}
}
...
func TestGroupAdapter_SetGroupPhoto_OK(t *testing.T) {
	called := false
	fake := &testkit.Fake{SetGroupPhotoFn: func(ctx context.Context, jid types.JID, avatar []byte) (string, error) {
		called = true
...
func TestGroupAdapter_SetGroupPhoto_NoSession(t *testing.T) {
	...
	if testkit.AppErrCode(err) != "no_session" {
		t.Errorf("SetGroupPhoto code = %q", testkit.AppErrCode(err))
	}
}
...
func TestGroupAdapter_SetGroupAnnounce_OK(t *testing.T) {
	called := false
	var seen bool
	fake := &testkit.Fake{SetGroupAnnounceFn: func(ctx context.Context, jid types.JID, announce bool) error {
		called = true
		seen = announce
		return nil
	}}
...
func TestGroupAdapter_SetGroupAnnounce_NoSession(t *testing.T) {
	...
	if testkit.AppErrCode(err) != "no_session" {
		t.Errorf("SetGroupAnnounce code = %q", testkit.AppErrCode(err))
	}
}
...
func TestGroupAdapter_SetGroupLocked_OK(t *testing.T) {
	called := false
	fake := &testkit.Fake{SetGroupLockedFn: func(ctx context.Context, jid types.JID, locked bool) error {
		called = true
		return nil
	}}
	a := NewGroupAdapter(testkit.GetterWith(map[string]client.Client{"u1": fake}))
...
func TestGroupAdapter_SetGroupLocked_NoSession(t *testing.T) {
	...
	if testkit.AppErrCode(err) != "no_session" {
		t.Errorf("SetGroupLocked code = %q", testkit.AppErrCode(err))
	}
}
...
func TestGroupAdapter_SetDisappearingTimer_OK(t *testing.T) {
	called := false
	fake := &testkit.Fake{SetDisappearingTimerFn: func(ctx context.Context, chat types.JID, timer time.Duration, ts time.Time) error {
		called = true
...
func TestGroupAdapter_SetDisappearingTimer_NoSession(t *testing.T) {
	...
	if testkit.AppErrCode(err) != "no_session" {
		t.Errorf("SetDisappearingTimer code = %q", testkit.AppErrCode(err))
	}
}
...
func TestGroupAdapter_SetJoinApprovalMode_OK(t *testing.T) {
	called := false
	fake := &testkit.Fake{SetGroupJoinApprovalModeFn: func(ctx context.Context, jid types.JID, mode bool) error {
		called = true
		return nil
	}}
	a := NewGroupAdapter(testkit.GetterWith(map[string]client.Client{"u1": fake}))
...
func TestGroupAdapter_SetJoinApprovalMode_NoSession(t *testing.T) {
	...
	if testkit.AppErrCode(err) != "no_session" {
		t.Errorf("SetJoinApprovalMode code = %q", testkit.AppErrCode(err))
	}
}
