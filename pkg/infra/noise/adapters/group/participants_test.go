...
func TestGroupAdapter_UpdateGroupParticipants_AddOK(t *testing.T) {
	var seen noise.ParticipantChange
	fake := &testkit.Fake{UpdateGroupParticipantsFn: func(ctx context.Context, jid types.JID, p []types.JID, action noise.ParticipantChange) ([]types.GroupParticipant, error) {
		seen = action
		return nil, nil
	}}
	...
	if seen != noise.ParticipantChangeAdd {
...
func TestGroupAdapter_UpdateGroupParticipants_RemoveOK(t *testing.T) {
	...
	if seen != noise.ParticipantChangeRemove {
...
func TestGroupAdapter_UpdateGroupParticipants_PromoteOK(t *testing.T) {
	...
	if seen != noise.ParticipantChangePromote {
...
func TestGroupAdapter_UpdateGroupParticipants_DemoteOK(t *testing.T) {
	...
	if seen != noise.ParticipantChangeDemote {
...
func TestGroupAdapter_UpdateRequestParticipants_Approve(t *testing.T) {
	var seen noise.ParticipantRequestChange
	fake := &testkit.Fake{UpdateGroupRequestParticipantsFn: func(ctx context.Context, jid types.JID, p []types.JID, action noise.ParticipantRequestChange) ([]types.GroupParticipant, error) {
		seen = action
	...
	if seen != noise.ParticipantChangeApprove {
...
func TestGroupAdapter_UpdateRequestParticipants_Reject(t *testing.T) {
	...
	if seen != noise.ParticipantChangeReject {
...
func TestGroupAdapter_UpdateRequestParticipants_Unknown(t *testing.T) {
	a := NewGroupAdapter(testkit.GetterWith(map[string]client.Client{"u1": &testkit.Fake{}}))
