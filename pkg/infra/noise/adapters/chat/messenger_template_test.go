...
func sendTemplateCapturing(t *testing.T, payload domain.TemplatePayload, _ *domain.ReplyContext, id string) (*waE2E.Message, []noise.SendRequestExtra) {
	t.Helper()
	...
	f := &testkit.Fake{
		SendMessageFn: func(_ context.Context, _ types.JID, m *waE2E.Message, extra ...noise.SendRequestExtra) (noise.SendResponse, error) {
			...
			return noise.SendResponse{ID: "template-wire-id", Timestamp: time.Unix(1755500130, 0)}, nil
		},
	}
...
func TestChatMessengerAdapter_SendTemplate_IDForwardedAndServerIDWins(t *testing.T) {
	...
	f := &testkit.Fake{
		SendMessageFn: func(_ context.Context, _ types.JID, _ *waE2E.Message, extra ...noise.SendRequestExtra) (noise.SendResponse, error) {
			...
			return noise.SendResponse{ID: "id-que-o-sdk-usou", Timestamp: sentAt}, nil
		},
	}
...
func TestChatMessengerAdapter_SendTemplate_SendFailurePropagates(t *testing.T) {
	f := &testkit.Fake{
		SendMessageFn: func(context.Context, types.JID, *waE2E.Message, ...noise.SendRequestExtra) (noise.SendResponse, error) {
			return noise.SendResponse{}, testkit.ErrSynthetic
		},
	}
