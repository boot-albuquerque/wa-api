// Package walog adapta o logger do noise vendorizado
// (internal/noise/util/log) para o zerolog da aplicação.
//
// É o único código de produção fora de internal/noise/ que implementa uma
// interface *do* vendored: concentrá-lo aqui limita o raio de explosão de um
// drift do upstream (ADR-0002/0003) e mantém pkg/infra/noise livre de
// dependência da interface log.Logger.
package log

// Chaves e valores de campo emitidos pelo bridge. Nomes de módulo espelham
// os que o noise usa nos seus próprios subloggers.
const (
	...
	// ModuleClient é o módulo do *noise.Client, do qual saem os
