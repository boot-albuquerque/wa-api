...
func TestNoiseSession_Subscribe(t *testing.T) {
	var handler noise.EventHandler
	removed := false
	client := &fakeSessionClient{
		AddEventHandlerFn: func(h noise.EventHandler) uint32 {
			handler = h
			return 42
		},
...
func TestNoiseSession_Subscribe_NilHandler(t *testing.T) {
