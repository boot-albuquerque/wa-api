...
// O parâmetro getClient é tipicamente clientManager.GetNoiseClient
// (convertido via clientForGetter).
func NewSessionGuardAdapter(getClient client.Getter) *SessionGuardAdapter {
...
// próprios.
func (a *SessionGuardAdapter) Client(txtID string) (client.Client, error) {
...
// localmente, cujo GetNoiseClient(id) devolvia interface{} — segundo o
