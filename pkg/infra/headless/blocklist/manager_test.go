...
func (b *blockerDuplo) Block(context.Context, string, string) (headless.BlockResult, error) {
	b.chamadas = append(b.chamadas, "block")
	return headless.BlockResult{}, b.err
}

func (b *blockerDuplo) Unblock(context.Context, string, string) (headless.BlockResult, error) {
...
func TestFalhaDeConfiguracaoPropaga(t *testing.T) {
	m := NewManager(adapter.NewSessions(registry.New(1), func(string) (headless.StartConfig, error) {
