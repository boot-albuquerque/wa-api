...
func TestOJIDDoSocketEConvertidoENaoRepassado(t *testing.T) {
	...
	want := "5511999999999" + waheadless.ServerPhone
	if got != want {
...
func TestToPageJIDPorNamespace(t *testing.T) {
	casos := map[domain.JID]string{
		"5511999999999@s.whatsapp.net": "5511999999999" + waheadless.ServerPhone,
		"5511999999999@c.us":           "5511999999999" + waheadless.ServerPhone,
		"5511999999999@lid":            "5511999999999" + waheadless.ServerLID,
		"120363000000000@g.us":         "120363000000000" + waheadless.ServerGroup,
		// Número nu: o padrão pertence ao ADAPTADOR, e o adaptador é este.
		"5511999999999":   "5511999999999" + waheadless.ServerPhone,
		"+5511999999999":  "5511999999999" + waheadless.ServerPhone,
		" 5511999999999 ": "5511999999999" + waheadless.ServerPhone,
	}
