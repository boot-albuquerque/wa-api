...
func (m *membersDuplo) AddParticipant(_ context.Context, _, _, _ string) (waheadless.GroupMembership, error) {
	m.chamadas = append(m.chamadas, "add")
	return waheadless.GroupMembership{Verified: m.verified, NoOp: m.verified}, m.err
}

func (m *membersDuplo) RemoveParticipant(_ context.Context, _, _, _ string) (waheadless.GroupMembership, error) {
...
func (a *alternante) AddParticipant(_ context.Context, _, _, _ string) (waheadless.GroupMembership, error) {
	a.n++
	return waheadless.GroupMembership{Verified: a.n == 1, NoOp: a.n == 1}, nil
}
func (a *alternante) RemoveParticipant(_ context.Context, _, _, _ string) (waheadless.GroupMembership, error) {
	return waheadless.GroupMembership{}, nil
}
