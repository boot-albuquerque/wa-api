...
func NewMediaDownloaderAdapter(getClient waclient.Getter) *MediaDownloaderAdapter {
...
func downloadableFor(descriptor domain.MediaDescriptor) (wanoise.DownloadableMessage, error) {
