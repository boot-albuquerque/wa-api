...
// ele.
func sendButtonsCapturingWithFake(t *testing.T, f *testkit.Fake, payload domain.ButtonsPayload, _ *domain.ReplyContext, mentionedJID []string, id string) (*waE2E.Message, []wanoise.SendRequestExtra, error) {
	t.Helper()
