...
func TestGroupAdapter_JoinGroup_OK(t *testing.T) {
	called := false
	fake := &waclienttest.Fake{JoinGroupWithLinkFn: func(ctx context.Context, code string) (types.JID, error) {
		called = true
...
func TestGroupAdapter_LeaveGroup_OK(t *testing.T) {
	called := false
	fake := &waclienttest.Fake{LeaveGroupFn: func(ctx context.Context, jid types.JID) error {
		called = true
		return nil
	}}
	a := NewGroupAdapter(waclienttest.GetterWith(map[string]waclient.Client{"u1": fake}))
...
func TestGroupAdapter_SetGroupName_OK(t *testing.T) {
	called := false
	fake := &waclienttest.Fake{SetGroupNameFn: func(ctx context.Context, jid types.JID, name string) error {
		called = true
		if name != "NewName" {
...
func TestGroupAdapter_SetGroupTopic_OK(t *testing.T) {
	called := false
	fake := &waclienttest.Fake{SetGroupTopicFn: func(ctx context.Context, jid types.JID, prev, new, topic string) error {
		called = true
...
func TestGroupAdapter_SetGroupPhoto_OK(t *testing.T) {
	called := false
	fake := &waclienttest.Fake{SetGroupPhotoFn: func(ctx context.Context, jid types.JID, avatar []byte) (string, error) {
		called = true
...
func TestGroupAdapter_SetGroupAnnounce_OK(t *testing.T) {
	called := false
	var seen bool
	fake := &waclienttest.Fake{SetGroupAnnounceFn: func(ctx context.Context, jid types.JID, announce bool) error {
		called = true
		seen = announce
		return nil
	}}
...
func TestGroupAdapter_SetGroupLocked_OK(t *testing.T) {
	called := false
	fake := &waclienttest.Fake{SetGroupLockedFn: func(ctx context.Context, jid types.JID, locked bool) error {
		called = true
		return nil
	}}
	a := NewGroupAdapter(waclienttest.GetterWith(map[string]waclient.Client{"u1": fake}))
...
func TestGroupAdapter_SetDisappearingTimer_OK(t *testing.T) {
	called := false
	fake := &waclienttest.Fake{SetDisappearingTimerFn: func(ctx context.Context, chat types.JID, timer time.Duration, ts time.Time) error {
		called = true
...
func TestGroupAdapter_SetJoinApprovalMode_OK(t *testing.T) {
	called := false
	fake := &waclienttest.Fake{SetGroupJoinApprovalModeFn: func(ctx context.Context, jid types.JID, mode bool) error {
		called = true
		return nil
	}}
	a := NewGroupAdapter(waclienttest.GetterWith(map[string]waclient.Client{"u1": fake}))
