...
| `demoteChannelAdmin` | — | `BLOCKED` | — | medido | — | H136: a cadeia FOI exercitada e para aqui. Passar Wid dá `Data passed to getter must include an id property`; passar o MODELO da coleção vai mais longe e morre em `Cannot read properties of undefined (reading 'isUser')` — a forma do SEGUNDO argumento não foi resolvida |
...
| `transferChannelOwnership` | — | `BLOCKED` | — | medido | — | H136: `WAWebChangeNewsletterOwnerAction.changeNewsletterOwnerAction` existe e **NÃO foi executada de propósito**: transferir a posse faria conta-A deixar de ser dona e não conseguir mais apagar o canal, deixando uma entidade real de pé. Recusa deliberada, não impossibilidade |
...
| `demoteChannelAdmin` | `BLOCKED` | H136: a cadeia FOI exercitada e para aqui — o modelo da coleção vai mais longe que o Wid e morre em `Cannot read properties of undefined (reading 'isUser')`; a forma do segundo argumento não foi resolvida |
| `transferChannelOwnership` | `BLOCKED` | H136: a ação existe e **não foi executada de propósito** — transferir a posse impediria conta-A de apagar o canal, deixando uma entidade real de pé. Recusa deliberada |
