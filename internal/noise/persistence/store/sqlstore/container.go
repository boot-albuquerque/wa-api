...
import (
	...
	"wa-api/internal/noise/persistence/store/sqlstore/upgrades"
	"wa-api/internal/noise/protocol/proto/waAdv"
	"wa-api/internal/noise/protocol/types"
	"wa-api/internal/noise/security/keys"
)

// Container is a wrapper for a SQL database that can contain multiple noise sessions.
...
func New(ctx context.Context, dialect, address string, log sdklog.Logger) (*Container, error) {
...
func NewWithDB(db *sql.DB, dialect string, log sdklog.Logger) *Container {
...
func NewWithWrappedDB(wrapped *dbutil.Database, log sdklog.Logger) *Container {
	if log == nil {
		log = sdklog.Noop
	}
	return &Container{
