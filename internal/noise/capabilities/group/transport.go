...
//
// Deliberadamente nao expoe nada do *noise.Client alem disso — e' o que
...
type Transport interface {
	...
	// (noise.WebMessageIDPrefix). O WhatsApp Web nao inclui esse prefixo na
	...
	// (*noise.ElementMissingError) e' generico do fork inteiro, nao do
