...
import (
	...
	cbcutil "wa-api/internal/noise/security/cbc"
)
...
// interface inteira sem precisar de um *noise.Client (nem de socket, store
...
func (f *fakeTransport) Log() sdklog.Logger       { return f.log }
