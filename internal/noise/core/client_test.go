...
import (
	...
	noise "wa-api/internal/noise/core"
...
func Example() {
	...
	dbLog := sdklog.Stdout("Database", "DEBUG", true)
	...
	clientLog := sdklog.Stdout("Client", "DEBUG", true)
	client := noise.NewClient(deviceStore, clientLog)
