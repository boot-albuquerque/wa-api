...
import (
	...
	proxyconf "wa-api/internal/noise/runtime/proxy"
)

// Proxy e SetProxyOptions sao aliases para os tipos de proxyconf. Precisam ser
// **aliases**, e nao tipos novos: `noise.SetProxyOptions` aparece nas
// assinaturas de SetProxy/SetSOCKSProxy/SetProxyAddress e e' usado por
// consumidores fora do fork (pkg/infra/noise/session). Um tipo distinto
