// Package headless is the facade of the browser-automation stack: the only
...
// internal/noise/ is enforced by scripts/waclient-facade-check.sh, and the
...
import (
	...
	"wa-api/internal/headless/capabilities/accounttype"
	"wa-api/internal/headless/capabilities/avatar"
	"wa-api/internal/headless/capabilities/block"
	"wa-api/internal/headless/capabilities/channel"
	"wa-api/internal/headless/capabilities/chats"
	"wa-api/internal/headless/capabilities/chatstate"
	"wa-api/internal/headless/capabilities/contacts"
	"wa-api/internal/headless/capabilities/edit"
	...
	"wa-api/internal/headless/capabilities/owner"
	"wa-api/internal/headless/capabilities/poll"
...
// doc above states: the adapter in pkg/infra/headless has to materialise
...
// registry in pkg/infra/headless needs to START a session, ASK whether it is
